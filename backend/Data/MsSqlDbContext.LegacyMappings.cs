...
{
    public partial class MsSqlDbContext
    {
        private void ConfigureLegacyMappings(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ApiVFixtureAll>(entity =>
            {
                entity.HasNoKey().ToView("api_v_fixture_all", "dbo");
                ...
                entity.Property(e => e.AwayImage).HasMaxLength(4000).HasColumnName("AWAY_IMAGE");
                entity.Property(e => e.AwayScore).HasColumnName("AWAY_SCORE");
                entity.Property(e => e.AwayTeamName).HasMaxLength(50).HasColumnName("AWAY_TEAM_NAME");
                ...
                entity.Property(e => e.FixtureId).HasMaxLength(50).HasColumnName("fixture_id");
                entity.Property(e => e.Home).HasMaxLength(50).HasColumnName("HOME");
                entity.Property(e => e.HomeImage).HasMaxLength(4000).HasColumnName("HOME_IMAGE");
                entity.Property(e => e.HomeScore).HasColumnName("HOME_SCORE");
                entity.Property(e => e.HomeTeamName).HasMaxLength(50).HasColumnName("HOME_TEAM_NAME");
                entity.Property(e => e.HomeUserId).HasColumnName("HOME_USER_ID");
                entity.Property(e => e.IsPlayed).HasMaxLength(3).IsUnicode(false).HasColumnName("IS_PLAYED");
            ...
            {
                entity.HasNoKey().ToView("api_v_result_table", "dbo");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
                entity.Property(e => e.Ga).HasColumnName("GA");
                entity.Property(e => e.Gd).HasColumnName("GD");
                entity.Property(e => e.Gf).HasColumnName("GF");
                entity.Property(e => e.Image).HasMaxLength(73).HasColumnName("IMAGE");
                entity.Property(e => e.Last).HasMaxLength(50);
                entity.Property(e => e.Platform).HasMaxLength(10).HasColumnName("PLATFORM");
                entity.Property(e => e.Pos).HasColumnName("POS");
                entity.Property(e => e.Season).HasColumnName("SEASON");
                entity.Property(e => e.Team).HasMaxLength(50).HasColumnName("TEAM");
                entity.Property(e => e.TeamName).HasMaxLength(50).HasColumnName("TEAM_NAME");
            ...
            modelBuilder.Entity<BotMessage>(entity =>
            {
                ...
                entity.Property(e => e.InputMsg).HasMaxLength(100).HasColumnName("input_msg");
                entity.Property(e => e.ResponseMsg).HasColumnName("response_msg");
            });

            modelBuilder.Entity<InsertUser>(entity =>
            {
                entity.HasNoKey().ToView("insert_user", "dbo");
                entity.Property(e => e.Expr1).HasMaxLength(32);
                entity.Property(e => e.Expr2).HasMaxLength(6).IsUnicode(false);
                entity.Property(e => e.Expr3).HasMaxLength(1).IsUnicode(false);
                entity.Property(e => e.Player).HasMaxLength(50).HasColumnName("PLAYER");
            ...
            modelBuilder.Entity<TblFixtureLog>(entity =>
            {
                ...
                entity.Property(e => e.FixtureId).HasMaxLength(50).HasDefaultValueSql("(newid())").HasColumnName("fixture_id");
                entity.Property(e => e.Active).HasMaxLength(3).HasColumnName("ACTIVE");
                entity.Property(e => e.Away).HasMaxLength(50).HasColumnName("AWAY");
                entity.Property(e => e.AwayScore).HasColumnName("AWAY_SCORE");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
            ...
            modelBuilder.Entity<TblLeave>(entity =>
            {
                ...
                entity.Property(e => e.LeaveId).HasDefaultValueSql("(newid())").HasColumnName("leave_id");
                entity.Property(e => e.DateFrom).HasMaxLength(10).HasColumnName("DATE_FROM");
                entity.Property(e => e.DateTo).HasMaxLength(10).HasColumnName("DATE_TO");
                entity.Property(e => e.Platform).HasMaxLength(2).IsUnicode(false).HasColumnName("PLATFORM");
                entity.Property(e => e.Reason).HasColumnName("REASON");
                entity.Property(e => e.UserId).HasMaxLength(10).IsFixedLength().HasColumnName("USER_ID");
            ...
            modelBuilder.Entity<TbmAnnouce>(entity =>
            {
                ...
                entity.Property(e => e.Announcer).HasMaxLength(50).HasColumnName("announcer");
                entity.Property(e => e.CreateDate).HasDefaultValueSql("(getdate())").HasColumnType("datetime").HasColumnName("create_date");
            ...
            modelBuilder.Entity<TbmCurrentSeason>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasDefaultValueSql("(newid())").HasColumnName("id");
                entity.Property(e => e.Platform).HasMaxLength(4).HasColumnName("platform");
                entity.Property(e => e.Season).HasColumnName("season");
            });
            ...
            modelBuilder.Entity<TbmFinalResult>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasMaxLength(50).HasDefaultValueSql("(newid())").HasColumnName("ID");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
                entity.Property(e => e.Ga).HasColumnName("GA");
                entity.Property(e => e.Gd).HasColumnName("GD");
                entity.Property(e => e.Gf).HasColumnName("GF");
                ...
                entity.Property(e => e.Season).HasColumnName("SEASON");
                entity.Property(e => e.Team).HasMaxLength(200).HasColumnName("TEAM");
                entity.Property(e => e.TeamName).HasMaxLength(50).HasColumnName("TEAM_NAME");
            });
            ...
            modelBuilder.Entity<TbmHof>(entity =>
            {
                ...
                entity.Property(e => e.HofId).HasMaxLength(50).HasDefaultValueSql("(newid())").HasColumnName("hof_id");
            ...
            modelBuilder.Entity<TbmNewMember>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasDefaultValueSql("(newid())").HasColumnName("id");
                entity.Property(e => e.Facebook).HasMaxLength(300).HasColumnName("facebook");
                entity.Property(e => e.MemberId).HasMaxLength(50).HasColumnName("member_id");
                entity.Property(e => e.MemberImage).HasColumnName("member_image");
                entity.Property(e => e.MemberName).HasMaxLength(100).HasColumnName("member_name");
                entity.Property(e => e.Platform).HasMaxLength(2).HasColumnName("platform");
            });
            ...
            modelBuilder.Entity<TbmTeam>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasMaxLength(50).HasDefaultValueSql("(newid())").HasColumnName("id");
                entity.Property(e => e.Division).HasMaxLength(50).HasColumnName("DIVISION");
                entity.Property(e => e.Image).HasMaxLength(50).HasColumnName("IMAGE");
                entity.Property(e => e.Md5TeamId).HasMaxLength(50).IsUnicode(false).HasColumnName("MD5_TEAM_ID");
            ...
            {
                entity.HasNoKey().ToView("v_current_team", "dbo");
                entity.Property(e => e.Division).HasMaxLength(50).HasColumnName("DIVISION");
            ...
            {
                entity.HasNoKey().ToView("v_fixture", "dbo");
                entity.Property(e => e.AImage).HasMaxLength(50).HasColumnName("A_IMAGE");
                entity.Property(e => e.AName).HasMaxLength(50).HasColumnName("A_NAME");
                entity.Property(e => e.Active).HasMaxLength(3).HasColumnName("ACTIVE");
                entity.Property(e => e.Away).HasMaxLength(50).HasColumnName("AWAY");
                entity.Property(e => e.AwayScore).HasColumnName("AWAY_SCORE");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
                entity.Property(e => e.FixtureId).HasMaxLength(50).HasColumnName("fixture_id");
                entity.Property(e => e.HImage).HasMaxLength(50).HasColumnName("H_IMAGE");
                entity.Property(e => e.Hname).HasMaxLength(50).HasColumnName("HNAME");
                entity.Property(e => e.Home).HasMaxLength(50).HasColumnName("HOME");
                entity.Property(e => e.HomeScore).HasColumnName("HOME_SCORE");
                entity.Property(e => e.Match).HasColumnName("MATCH");
                entity.Property(e => e.Season).HasColumnName("SEASON");
            ...
            {
                entity.HasNoKey().ToView("v_fixture_all", "dbo");
                entity.Property(e => e.Active).HasMaxLength(3).HasColumnName("ACTIVE");
                entity.Property(e => e.Away).HasMaxLength(50).HasColumnName("AWAY");
                entity.Property(e => e.AwayImage).HasMaxLength(73).HasColumnName("AWAY_IMAGE");
                entity.Property(e => e.AwayScore).HasColumnName("AWAY_SCORE");
                entity.Property(e => e.AwayTeamName).HasMaxLength(50).HasColumnName("AWAY_TEAM_NAME");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
                entity.Property(e => e.FixtureId).HasMaxLength(50).HasColumnName("fixture_id");
                entity.Property(e => e.Home).HasMaxLength(50).HasColumnName("HOME");
                entity.Property(e => e.HomeImage).HasMaxLength(73).HasColumnName("HOME_IMAGE");
                entity.Property(e => e.HomeScore).HasColumnName("HOME_SCORE");
                entity.Property(e => e.HomeTeamName).HasMaxLength(50).HasColumnName("HOME_TEAM_NAME");
                entity.Property(e => e.Match).HasColumnName("MATCH");
                entity.Property(e => e.Platform).HasMaxLength(10).HasColumnName("PLATFORM");
            ...
            {
                entity.HasNoKey().ToView("v_fixture_all_log", "dbo");
                entity.Property(e => e.Active).HasMaxLength(3).HasColumnName("ACTIVE");
                entity.Property(e => e.Away).HasMaxLength(50).HasColumnName("AWAY");
                entity.Property(e => e.AwayImage).HasMaxLength(73).HasColumnName("AWAY_IMAGE");
                entity.Property(e => e.AwayScore).HasColumnName("AWAY_SCORE");
                ...
                entity.Property(e => e.Match).HasColumnName("MATCH");
                entity.Property(e => e.MatchDate).HasColumnType("datetime").HasColumnName("MATCH_DATE");
                entity.Property(e => e.MatchDateDisplay).HasMaxLength(10).HasColumnName("MATCH_DATE_DISPLAY");
                entity.Property(e => e.Platform).HasMaxLength(10).HasColumnName("PLATFORM");
                entity.Property(e => e.ResultImage).HasMaxLength(14).IsUnicode(false).HasColumnName("RESULT_IMAGE");
                entity.Property(e => e.Season).HasColumnName("SEASON");
            });

            modelBuilder.Entity<VHof>(entity =>
            {
                entity.HasNoKey().ToView("v_hof", "dbo");
                entity.Property(e => e.D1).HasMaxLength(255);
                entity.Property(e => e.D1Image).HasMaxLength(272).HasColumnName("D1_IMAGE");
                entity.Property(e => e.D2).HasMaxLength(255);
                entity.Property(e => e.D2Image).HasMaxLength(272).HasColumnName("D2_IMAGE");
                entity.Property(e => e.FaCup).HasMaxLength(255).HasColumnName("FA CUP");
                entity.Property(e => e.FaImage).HasMaxLength(272).HasColumnName("FA_IMAGE");
                entity.Property(e => e.HofId).HasMaxLength(50).HasColumnName("hof_id");
                entity.Property(e => e.LcImage).HasMaxLength(272).HasColumnName("LC_IMAGE");
                entity.Property(e => e.LeagueCup).HasMaxLength(255).HasColumnName("LEAGUE CUP");
                entity.Property(e => e.Platform).HasMaxLength(255).HasColumnName("PLATFORM");
                entity.Property(e => e.Season).HasColumnName("SEASON");
                entity.Property(e => e.SeasonImage).HasMaxLength(19).IsUnicode(false).HasColumnName("SEASON_IMAGE");
                entity.Property(e => e.ThImage).HasMaxLength(272).HasColumnName("TH_IMAGE");
                entity.Property(e => e.ThaiClubCup).HasMaxLength(255).HasColumnName("THAI CLUB CUP");
            });

            modelBuilder.Entity<VLastFixture>(entity =>
            {
                entity.HasNoKey().ToView("v_last_fixture", "dbo");
            ...
            {
                entity.HasNoKey().ToView("v_player_draw", "dbo");
                entity.Property(e => e.Division).HasMaxLength(50).HasColumnName("DIVISION");
            ...
            {
                entity.HasNoKey().ToView("v_result_table", "dbo");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
                entity.Property(e => e.Ga).HasColumnName("GA");
                entity.Property(e => e.Gd).HasColumnName("GD");
                entity.Property(e => e.Gf).HasColumnName("GF");
                entity.Property(e => e.Id).HasColumnName("ID");
                entity.Property(e => e.Image).HasMaxLength(71).HasColumnName("IMAGE");
                entity.Property(e => e.Season).HasColumnName("SEASON");
                entity.Property(e => e.Team).HasMaxLength(103).HasColumnName("TEAM");
                entity.Property(e => e.TeamName).HasMaxLength(50).HasColumnName("TEAM_NAME");
            });

            modelBuilder.Entity<VResultTableCalculate>(entity =>
            {
                entity.HasNoKey().ToView("v_result_table_calculate", "dbo");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
                entity.Property(e => e.Ga).HasColumnName("GA");
                entity.Property(e => e.Gd).HasColumnName("GD");
                entity.Property(e => e.Gf).HasColumnName("GF");
            ...
            {
                entity.HasNoKey().ToView("v_result_table_new", "dbo");
                entity.Property(e => e.Division).HasMaxLength(2).HasColumnName("DIVISION");
                entity.Property(e => e.Ga).HasColumnName("GA");
                entity.Property(e => e.Gd).HasColumnName("GD");
                entity.Property(e => e.Gf).HasColumnName("GF");
