...
namespace eTPL.API.Controllers
{
    ...
    public class HofController : ControllerBase
    {
        ...
        private async Task SeedMockData()
        {
            ...
            {
                // League Champions
                new TbmHof { HofId = Guid.NewGuid().ToString(), TournamentTitle = "eTPL League", TournamentSubtitle = "D1 Division · Top Tier", Season = "Season 5", WinnerName = "RREEF", WinnerTeam = "AZ ALKMAAR", RunnerUpName = "Viper", DisplayColor = "#fbbf24", Platform = "PC", WinnerImage = "https://i.pravatar.cc/150?u=rreef" },
                new TbmHof { HofId = Guid.NewGuid().ToString(), TournamentTitle = "eTPL League", TournamentSubtitle = "D1 Division · Top Tier", Season = "Season 4", WinnerName = "Alice", WinnerTeam = "FC Porto", RunnerUpName = "Bob", DisplayColor = "#fbbf24", Platform = "PC", WinnerImage = "https://i.pravatar.cc/150?u=alice" },
                new TbmHof { HofId = Guid.NewGuid().ToString(), TournamentTitle = "eTPL League", TournamentSubtitle = "D1 Division · Top Tier", Season = "Season 3", WinnerName = "Zlatan", WinnerTeam = "Milan", RunnerUpName = "Rooney", DisplayColor = "#fbbf24", Platform = "PC", WinnerImage = "https://i.pravatar.cc/150?u=zlatan" },
                new TbmHof { HofId = Guid.NewGuid().ToString(), TournamentTitle = "eTPL League", TournamentSubtitle = "D1 Division · Top Tier", Season = "Season 2", WinnerName = "Messi", WinnerTeam = "Barcelona", RunnerUpName = "CR7", DisplayColor = "#fbbf24", Platform = "PC", WinnerImage = "https://i.pravatar.cc/150?u=messi" },
                new TbmHof { HofId = Guid.NewGuid().ToString(), TournamentTitle = "eTPL League", TournamentSubtitle = "D1 Division · Top Tier", Season = "Season 1", WinnerName = "RREEF", WinnerTeam = "Santos", RunnerUpName = "Pele", DisplayColor = "#fbbf24", Platform = "PC", WinnerImage = "https://i.pravatar.cc/150?u=rreef" },
